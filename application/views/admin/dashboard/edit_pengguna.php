...
var txt="UPT KSLI UNIB | EDIT PENGGUNA ";
var speed=300;
var refresh=null;
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <button onclick="window.location.href='<?=base_url('admin/pengguna')?>'" style="border-radius:10px; margin-bottom:10px" class="btn btn-primary"><i class="icofont-arrow-left"></i> Kembali</button>
    
      <div class="box-header with-border">
        <h2 class="justify-content-center text-center" style=" font-weight: 700;
  margin-bottom: 20px;
  font-size: 30px;
  color: #fff;">Ubah data Pengguna</h2>
        </div>
        <!-- /.box-header -->
        <?php foreach($data_pengguna as $pgn) { ?>
          <!-- form start -->
          <form action="<?=base_url('admin/pengguna/ubah_pengguna');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-2 control-label">Nama</label>
                <input type="hidden" name="id" value="<?= $pgn->id;?>">
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama" value="<?= $pgn->nama;?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Email</label>
                <div class="col-sm-12">
                  <input type="email" class="form-control" name="email" value="<?= $pgn->email;?>" required></input>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Password</label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="password" value="<?= $pgn->password;?>" required></input>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                <img src="<?php echo base_url('assets/dua/img/profil/'.$pgn->foto)?> " width="200" height="100">
