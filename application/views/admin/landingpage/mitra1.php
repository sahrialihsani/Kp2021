...
<?= $this->session->flashdata('email_sent'); ?>
  ...
  color: #fff;">Mitra Kerjasama</h2>
   <?php echo anchor('admin/mitra/tambah','<button class="btn btn-primary">Tambah Data</button>') ?>
    <br>
    <br>
      ...
      <table id="example" class="table table-responsive table-striped table-flush table-borderless" style="width:100%">
        ...
        <?php 
            ...
            echo'<img style="object-fit: cover;" src="'.$path.'" alt=""  width="200px" height="150px">';
            }
        ?>
  ...
  <div   class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <input style="color:#ffffff;" type="text" name="institusi" class="form-control" required>
        ...
        <div class="form-group">
          <label>Negara</label>
          <select name="id" class="form-control" required oninvalid="this.setCustomValidity('Silahkan Pilih Negara Asal Anda')" oninput="setCustomValidity('')">
