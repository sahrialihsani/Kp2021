...
var txt="UPT KSLI UNIB | EDIT STAF ";
var speed=300;
var refresh=null;
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <button onclick="window.location.href='<?=base_url('admin/staf')?>'" style="border-radius:10px; margin-bottom:10px" class="btn btn-primary"><i class="icofont-arrow-left"></i> Kembali</button>
    
      <div class="box-header with-border">
        <h2 class="justify-content-center text-center" style=" font-weight: 700;
  margin-bottom: 20px;
  font-size: 30px;
  color: #fff;">Ubah data Staf</h2>
        </div>
        <!-- /.box-header -->
          ...
          <form action="<?=base_url('admin/staf/ubah_staf');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="number" class="form-control" name="nip" value="<?= $stf->nip;?>" required>
                </div>
              </div>
                ...
                <div class="col-sm-12">
                  <input type="text" rows="5" class="form-control" name="nama" value="<?= $stf->nama;?>"required></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="jabatan" value="<?= $stf->jabatan;?>"required></input>
                </div>
              </div>
