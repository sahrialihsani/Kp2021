...
var txt="UPT KSLI UNIB | EDIT PROGRAM ";
var speed=300;
var refresh=null;
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <button onclick="window.location.href='<?=base_url('admin/program')?>'" style="border-radius:10px; margin-bottom:10px" class="btn btn-primary"><i class="icofont-arrow-left"></i> Kembali</button>
    
      <div class="box-header with-border">
        <h2 class="justify-content-center text-center" style=" font-weight: 700;
  margin-bottom: 20px;
  font-size: 30px;
  color: #fff;">Ubah data Program</h2>
        </div>
        <!-- /.box-header -->
        <?php foreach($data_program as $prg) { ?>
          <!-- form start -->
          <form action="<?=base_url('admin/program/ubah_program');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-2 control-label">Nama</label>
                <input type="hidden" name="id" value="<?= $prg->id;?>">
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama" value="<?= $prg->nama;?>" required>
                </div>
              </div>
                ...
                <div class="col-sm-12">
                  <textarea type="text" rows="5" class="form-control" name="keterangan" required><?= $prg->keterangan;?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tahun" value="<?= $prg->tahun;?>" required></input>
                </div>
              </div>
