...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <button onclick="window.location.href='<?=base_url('admin/pangkalandata/swasta')?>'" style="border-radius:10px; margin-bottom:10px" class="btn btn-primary"><i class="icofont-arrow-left"></i> Kembali</button>
  ...
  color: #fff;">Ubah data Kerjasama</h2>
        ...
        <!-- /.box-header -->
        <?php foreach($data_swasta as $sws) { ?>
          <!-- form start -->
          <form action="<?=base_url('admin/pangkalandata/ubah_swasta');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="box-body">
            ...
            foreach($result  as $rsl) : ?>
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="nama_kerjasama" value="<?= $sws->nama_kerjasama;?>"required></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                <input type="text" class="form-control" name="no_kerjasama" required value="<?= $sws->no_kerjasama;?>"></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <textarea type="text" class="form-control" name="isi" required><?= $sws->isi;?></textarea>
                </div>
              </div>
...
<div class="form-group">
      ...
      ?>
                  <input type="file" class="form-control" name="file" value="<?= $sws->file;?>"required></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="date" class="form-control" name="tgl_mulai" value="<?= $sws->tgl_mulai;?>"required></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="date" class="form-control" name="tgl_akhir" value="<?= $sws->tgl_akhir;?>"required></input>
                </div>
              </div>
