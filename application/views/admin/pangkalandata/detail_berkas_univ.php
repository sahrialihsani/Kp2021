...
<header class="panel-heading">
  ...
  <?php foreach($detail_berkas_univ as $berkas): ?>
  <embed type="application/pdf" src="<?=base_url('assets/dua/berkas/kerjasama/universitas/').$berkas->file?>" width="100%" height="100%"></embed>
  <?php endforeach;?>
        </div>
    </div>
</header>
