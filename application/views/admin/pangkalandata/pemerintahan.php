...
<button class="btn btn-sm btn-primary float-left ml-2" data-toggle="modal" data-target="#tambah_pemerintahan">Tambah Data Kerjasama</button>
  <br>
  <br>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-warning btn-flat btn-xs">Aksi</button>
                    ...
                    <ul style="background-color:#fff" class="dropdown-menu" role="menu">
                      <li><a style="padding-left:5px;padding-bottom:3px;padding-top:3px;color:#000" href="<?= base_url('admin/pangkalandata/editPemerintahan/') . $pmr->id; ?>"> Edit Data</a></li>
                      <li><a style="padding-left:5px;padding-bottom:3px;padding-top:3px;color:#000" href="<?= base_url('admin/pangkalandata/hapusPemerintahan/') . $pmr->id; ?>" onclick="return confirm('Apakah yakin data ini di hapus?')">Hapus Data</a></li>
                    </ul> 
                  </div>
                </td>
              </tr>
...
<div class="modal fade" id="tambah_pemerintahan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div   class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
       <h5 style="color:#3f80ba" class="modal-title" id="exampleModalLabel">Input data kerjasama dengan Pemerintahan</h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <div style="background-color:#3f80ba" class="modal-body">
    <form action="<?= base_url('admin/pangkalandata/tambahPemerintahan');?>" method="post" enctype="multipart/form-data">
