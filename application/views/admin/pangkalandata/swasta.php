...
var txt="UPT KSLI UNIB | KERJASAMA PERUSAHAAN ";
var speed=300;
var refresh=null;
...
margin-bottom: 20px;
font-size: 30px;
color: #fff;">Kerjasama dengan Perusahaan</h2>
<button onclick="window.location.href='<?=base_url('cetak/cetakswasta')?>'"  class="btn btn-sm btn-primary float-left ml-2"><i class="icofont-print"></i>Cetak Data</button>

<button class="btn btn-sm btn-primary float-left ml-2" data-toggle="modal" data-target="#tambah_swasta">Tambah Data Kerjasama</button>
  <br>
  <br>
      ...
      <td><?=date('d F Y', strtotime($sws->tgl_akhir)); ?></td>  
                <td>
                  ...
                  <button type="button" class="btn btn-warning btn-flat btn-xs">Aksi</button>
                    ...
                    <li><a style="padding-left:5px;padding-bottom:3px;padding-top:3px;color:#000" href="<?= base_url('admin/pangkalandata/editSwasta/') . $sws->id; ?>"> <i class="icofont-ui-edit">Edit Data</i></a></li>
                      <li><a style="padding-left:5px;padding-bottom:3px;padding-top:3px;color:#000" href="<?= base_url('admin/pangkalandata/hapusSwasta/') . $sws->id; ?>" onclick="return confirm('Apakah yakin data ini di hapus?')"><i class="icofont-ui-delete">Hapus Data</i></a></li>
                 </ul> 
                  </div>
                </td>
              </tr>
...
<div class="modal fade" id="tambah_swasta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div   class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
       <h5 style="color:#3f80ba" class="modal-title" id="exampleModalLabel">Input data kerjasama dengan Swasta</h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <div style="background-color:#3f80ba" class="modal-body">
    <form action="<?= base_url('admin/pangkalandata/tambahSwasta');?>" method="post" enctype="multipart/form-data">
