...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <button onclick="window.location.href='<?=base_url('admin/pangkalandata/universitas')?>'" style="border-radius:10px; margin-bottom:10px" class="btn btn-primary"><i class="icofont-arrow-left"></i> Kembali</button>
  ...
  color: #fff;">Ubah data Kerjasama</h2>
        ...
        <!-- /.box-header -->
        <?php foreach($data_universitas as $unv) { ?>
          <!-- form start -->
          <form action="<?=base_url('admin/pangkalandata/ubah_universitas');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="box-body">
            ...
            foreach($result  as $rsl) : ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <textarea type="text" class="form-control" name="isi" required><?= $unv->isi;?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="date" class="form-control" name="tgl_mulai" value="<?= $unv->tgl_mulai;?>"required></input>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="date" class="form-control" name="tgl_akhir" value="<?= $unv->tgl_akhir;?>"required></input>
                </div>
              </div>
