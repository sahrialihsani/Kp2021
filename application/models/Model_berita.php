...
class Model_berita extends CI_Model{
	...
	$hasil=$this->db->query("SELECT tb_berita.id, tb_berita.judul, tb_berita.isi,tb_berita.gambar, tb_berita.tgl_posting, tb_kategori.kategori FROM tb_berita  join tb_kategori on tb_berita.id_kategori=tb_kategori.id ORDER BY tb_berita.tgl_posting ASC");
            return $hasil;
	}
